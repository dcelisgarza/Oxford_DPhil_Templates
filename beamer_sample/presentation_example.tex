...
%------------------------------ Logos -----------------------------%
% Background image.
\pgfdeclareimage[width=\paperwidth]{titlebackground}{./images/background.eps}
% Oxford logo.
\pgfdeclareimage[width=0.9cm]{oxfordlogo}{./images/ox_brand_cmyk_pos.eps}
% Department logo.
\pgfdeclareimage[width=30pt]{deptlogo}{./images/materials_logo2.pdf}
% Subtitle font size.
